...
import { ArrowRight, ChevronRight, Menu, X, FileText, Sparkles, Shield, Zap } from 'lucide-react'
          ...
          <div className="relative pt-24 md:pt-36">
            ...
            >
              <img
                ...
                alt="background"
                className="absolute inset-x-0 top-56 -z-20 hidden lg:top-32 dark:block object-cover w-full opacity-30"
                width="1920"
                height="1080"
              />
            </AnimatedGroup>
            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                <AnimatedGroup variants={transitionVariants}>
                  ...
                  <h1 className="mt-8 max-w-4xl mx-auto text-balance text-5xl font-bold md:text-6xl lg:mt-16 xl:text-[5.25rem]">
            ...
            >
              <div className="relative -mr-56 mt-8 overflow-hidden px-2 sm:mr-0 sm:mt-12 md:mt-20">
                ...
                <div className="inset-shadow-2xs ring-background dark:inset-shadow-white/20 bg-background relative mx-auto max-w-6xl overflow-hidden rounded-2xl border p-4 shadow-lg shadow-zinc-950/15 ring-1">
                  <img
                    className="bg-background aspect-video relative rounded-2xl border"
                    src="/images/dashboard-preview.jpg"
                    alt="Paper dashboard preview"
                    width="1920"
                    height="1080"
                  />
                </div>
    ...
    >
      <div className="bg-foreground/10 rounded-[14px] border p-0.5">
        {isLoaded && isSignedIn ? (
          ...
          <Button size="lg" className="rounded-xl px-5 text-base" onClick={openSignUp}>
          ...
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
            <div className="flex w-full justify-between lg:w-auto">
              <Link href="/" aria-label="home" className="flex items-center space-x-2">
                ...
                <span className="font-semibold text-xl">paper</span>
              </Link>
